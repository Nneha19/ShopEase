...
import CardTile from "../components/cart-tile";
...
export default function Cart() {
  ...
  return (
    <div className="flex justify-center lg:pr-10 lg:pl-20">
      {cart && cart.length ? (
        <>
          <div className="min-h-[60vh] grid md:grid-cols-2 max-w-6xl mx-auto">
            <div className="flex flex-col justify-center items-center p-3">
              {cart.map((cartItem) => (
                <CardTile cartItem={cartItem} />
              ))}
            </div>
          </div>
        ...
        <div className="min-h-[80vh] flex flex-col items-center justify-center">
          <h1 className="text-gray-800 font-bold text-xl mb-2">
            Your cart is empty. Explore some products...{" "}
          </h1>
          <Link to="/">
